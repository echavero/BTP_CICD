		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#logaligroupprojectfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupprojectfiori-display": {
								"semanticObject": "logaligroupprojectfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.projectfiori",
									"url": sap.ui.require.toUrl("logaligroup/projectfiori")
								}
							}
						}
					}
